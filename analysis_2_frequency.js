 ...
 * Calculates frequency for a target class.
 */
...
/**
 * Calculates how many times a specific class appeared over the time series.
 * @param {ee.Image} image - The multi-band LULC image.
 * @param {number} targetClass - The class value to count.
 * @param {Array} years - Array of years.
 * @param {string} bandPrefix - Prefix of the band names.
 * @returns {ee.Image} - Image with the sum of occurrences.
 */
